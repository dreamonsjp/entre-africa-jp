...
function wdi_load_frontend_scripts(){
  ...
  wp_enqueue_script('wdi_lazy_load',plugins_url('../js/jquery.lazyload.min.js', __FILE__),array("jquery"), get_pro_version() );

  wp_enqueue_script('wdi_frontend',plugins_url('../js/wdi_frontend.js', __FILE__),array("jquery",'wdi_instagram','wdi_lazy_load'), get_pro_version());
  wp_enqueue_script('wdi_responsive',plugins_url('../js/wdi_responsive.js', __FILE__),array("jquery","wdi_frontend"), get_pro_version());
